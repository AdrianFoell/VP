...
const kanaele_service_1 = require('../service/kanaele_service');
const kanal_1 = require('../model/kanal');
const shared_1 = require('../../shared/shared');
class KanaeleRequestHandler {
    constructor() {
        this._kanaeleService = new kanaele_service_1.default();
    }
    getById(req, res) {
        ...
        this._kanaeleService
            ...
            shared_1.logger.debug(`getById(): kanal = ${JSON.stringify(kanal)}`);
            res.json(kanal);
        })
    ...
    getByQuery(req, res) {
        ...
        this._kanaeleService
            .find(query)
            .then((kanaele) => {
            shared_1.logger.debug(`getByQuery(): buecher = ${JSON.stringify(kanaele)}`);
            if (kanaele.length === 0) {
            ...
            // Link Header
            const baseUri = shared_1.getBaseUri(req);
            const firstId = kanaele[0]._id.valueOf();
            const lastId = kanaele[kanaele.length - 1]._id.valueOf();
            res.links({
                self: `${baseUri}`,
                list: `${baseUri}`,
    ...
    post(req, res) {
        ...
        const kanal = new kanal_1.Kanal(req.body);
        shared_1.logger.debug(`Body: ${JSON.stringify(kanal)}`);
        const err = kanal_1.validateKanal(kanal);
        if (err !== null) {
...
], KanaeleRequestHandler.prototype, "getById", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], KanaeleRequestHandler.prototype, "getByQuery", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], KanaeleRequestHandler.prototype, "post", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], KanaeleRequestHandler.prototype, "put", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], KanaeleRequestHandler.prototype, "deleteMeth", null);
// -----------------------------------------------------------------------
// E x p o r t i e r t e   F u n c t i o n s
// -----------------------------------------------------------------------
const kanaeleRequestHandler = new KanaeleRequestHandler();
