...
const buecher_service_mock_1 = require('../service/mock/buecher_service_mock');
...
class BuecherRequestHandler {
    constructor() {
        ...
        shared_1.mongoMock ? new buecher_service_mock_1.default() : new buecher_service_1.default();
    }
    ...
    post(req, res) {
        ...
        const err = buch_1.validateBuch(buch);
        if (err !== null) {
...
], BuecherRequestHandler.prototype, "getById", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], BuecherRequestHandler.prototype, "getByQuery", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], BuecherRequestHandler.prototype, "post", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], BuecherRequestHandler.prototype, "put", null);
__decorate([
    shared_1.log, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], BuecherRequestHandler.prototype, "deleteMeth", null);
// -----------------------------------------------------------------------
// E x p o r t i e r t e   F u n c t i o n s
// -----------------------------------------------------------------------
const buecherRequestHandler = new BuecherRequestHandler();
function getById(req, res) {
    'use strict';
    buecherRequestHandler.getById(req, res);
}
exports.getById = getById;
function getByQuery(req, res) {
    'use strict';
    buecherRequestHandler.getByQuery(req, res);
}
exports.getByQuery = getByQuery;
function post(req, res) {
    'use strict';
    buecherRequestHandler.post(req, res);
}
exports.post = post;
function put(req, res) {
    'use strict';
    buecherRequestHandler.put(req, res);
}
exports.put = put;
function deleteFn(req, res) {
    'use strict';
    buecherRequestHandler.deleteMeth(req, res);
}
