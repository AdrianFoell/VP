...
const roleSchema: Schema = new Schema({roles: {type: [String], index: true}});

// automat. Validierung der Indexe beim 1. Zugriff
roleSchema.set('autoIndex', AUTO_INDEX);
...
export const Role: Model<Document> = model('Role', roleSchema);
