...
declare module "mongoose" {
  import {NodeJS, Buffer} from "node";
  ...
  export interface Model<T extends Document> extends NodeJS.EventEmitter {
    ...
    */
    ...
    findByIdAndUpdate(id: string, update: Object, callback?: (err: any, res: T) => void): Promise<T>;
    findByIdAndUpdate(id: string, update: Object, options: FindAndUpdateOption, callback?: (err: any, res: T) => void): Promise<T>;
    ...
    findOneAndRemove(cond: Object, callback?: (err: any, res: T) => void): Promise<T>;
    findOneAndRemove(cond: Object, options: Object, callback?: (err: any, res: T) => void): Promise<T>;
