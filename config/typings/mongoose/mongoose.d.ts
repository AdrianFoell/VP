// Juergen Zimmermann: Anpassung von mongoose aus DefinitelyTyped an Version 4.x
// Promise<> statt Query<>
...
export interface Model<T extends Document> extends NodeJS.EventEmitter {
    ...
    */
    ...
    find(cond?: Object, callback?: (err: any, res: T[]) => void): Promise<T[]> | Query<T>;
    find(cond?: Object, fields?: Object, callback?: (err: any, res: T[]) => void): Promise<T[]> | Query<T>;
    find(cond?: Object, fields?: Object, options?: Object, callback?: (err: any, res: T[]) => void): Promise<T[]> | Query<T>;
    findById(id: string, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findById(id: string, fields: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findById(id: string, fields: Object, options: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findByIdAndRemove(id: string, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findByIdAndRemove(id: string, options: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findByIdAndUpdate(id: string, update: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findByIdAndUpdate(id: string, update: Object, options: FindAndUpdateOption, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOne(cond?: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOne(cond: Object, fields: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOne(cond: Object, fields: Object, options: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOneAndRemove(cond: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOneAndRemove(cond: Object, options: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOneAndUpdate(cond: Object, update: Object, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    findOneAndUpdate(cond: Object, update: Object, options: FindAndUpdateOption, callback?: (err: any, res: T) => void): Promise<T> | Query<T>;
    ...
    */
    ...
    update(cond: Object, update: Object, callback?: (err: any, affectedRows: number, raw: any) => void): Promise<T>;
    update(cond: Object, update: Object, options: Object, callback?: (err: any, affectedRows: number, raw: any) => void): Promise<T>;
    remove(cond: Object, callback?: (err: any) => void): Promise<{}>;
    save(callback?: (err: any, result: T, numberAffected: number) => void): Promise<T>;
    where(path: string, val?: Object): Promise<T[]>;
...
export class Query<T> {
    ...
    */
    and(array: Object[]): Query<T> | Promise<[T]>;
    ...
    */
    ...
    select(arg: string): Query<T> | Promise<T>;
    select(arg: Object): Query<T> | Promise<T>;
    ...
    */
    ...
    sort(arg: Object): Query<T> | Promise<T[]>;
    sort(arg: string): Query<T> | Promise<T[]>;
    ...
    where(path?: string, val?: any): Query<T> | Promise<T>;
    where(path?: Object, val?: any): Query<T> | Promise<T>;
